...
def project_um():
    ...
    chart = lineChart(name="lineChart Dowkanong D.O.", width=1244)
    xdata = range(1, 32)
    ...
    chart.add_serie(y=ydata, x=xdata, name='ก.ค.', extra=extra_serie)
    extra_serie = {"tooltip": {"y_start": "", "y_end": " calls"}}
    chart.add_serie(y=ydata2, x=xdata, name='ส.ค.', extra=extra_serie)
    extra_serie = {"tooltip": {"y_start": "", "y_end": " calls"}}
    chart.add_serie(y=ydata3, x=xdata, name='ก.ย.', extra=extra_serie)
    chart.buildhtml()
