...
def project_um():
    ...
    chart.add_serie(y=ydata, x=xdata, name='เม.ย.', extra=extra_serie)
    extra_serie = {"tooltip": {"y_start": "", "y_end": " calls"}}
    chart.add_serie(y=ydata2, x=xdata, name='พ.ค.', extra=extra_serie)
    extra_serie = {"tooltip": {"y_start": "", "y_end": " calls"}}
    chart.add_serie(y=ydata3, x=xdata, name='มิ.ย.', extra=extra_serie)
    extra_serie = {"tooltip": {"y_start": "", "y_end": " calls"}}
    chart.add_serie(y=ydata4, x=xdata, name='ก.ค.', extra=extra_serie)
    extra_serie = {"tooltip": {"y_start": "", "y_end": " calls"}}
    chart.add_serie(y=ydata5, x=xdata, name='ส.ค.', extra=extra_serie)
    extra_serie = {"tooltip": {"y_start": "", "y_end": " calls"}}
    chart.add_serie(y=ydata6, x=xdata, name='ก.ย.', extra=extra_serie)
    chart.buildhtml()
